...
DEFAULT_CONFIGS: list[dict] = [
    ...
    {"key": "min_queries_for_entropy", "value": "20", "desc": "Mínimo de queries na janela para calcular entropia (evita falsos positivos com tráfego baixo)", "group": "detection"},
    {"key": "min_qps_for_entropy", "value": "100", "desc": "QPS mínimo para ativar algoritmos de entropia (abaixo disso, diversidade é tráfego recursivo normal)", "group": "detection"},
    ...
    {"key": "weight_domain_entropy", "value": "10", "desc": "Peso da entropia de domínios no score composto (%)", "group": "detection"},
    {"key": "weight_discard_rate", "value": "10", "desc": "Peso da taxa de frames descartados no score composto (%)", "group": "detection"},
    {"key": "ddos_discard_rate_threshold", "value": "30", "desc": "% de frames descartados para considerar suspeito", "group": "detection"},
    {"key": "alarm_silence_minutes", "value": "60", "desc": "Minutos de silêncio após disparo de alarme", "group": "detection"},
    {"key": "min_windows_for_attack", "value": "6", "desc": "Janelas consecutivas em estado suspeito antes de abrir evento (janela=10s, padrão 6 = ~60s mínimo)", "group": "detection"},
    # --- Retenção ---
    {"key": "metric_retention_days", "value": "7", "desc": "Dias de retenção das métricas (últimos N dias — inclui todos os scores para análise retroativa)", "group": "retention"},
    # --- Notificações ---
